...
dbHandler.prototype = {
addObjectStore: function(store_name, store_conf, cb){
...
deleteDB:function(cb){
	...
	req.onblocked = function () {
		cb("Couldn't delete database due to operation being blocked", null);
	};
},
deleteEverything:function(cb){
	console.log('deleting everything');
	Promise.all([this.deleteDBAsync(), this.deleteAllAttachmentsAsync()])
		.then(cb)
		.catch(cb);
},
deleteAllAttachments:function(cb){
...
ensureProjectStore:function(cb){ // Is this necessary? Isn't the project ensured in the initial connect() method?
...
ensureLocalBoxes:function(boxes, cb){
...
saveMailToLocalBox:function(mailbox_name, mail_obj, cb){
...
findFirstMailWithProperty:function(property, values, current_index, cb){
...
findMailWithProperty:function(property, value, cb){
...
getMailFromBoxWithProperty:function(mailbox_name, property, value, cb){
...
updateFlags:function(box_name, uid, flags, cb){
...
removeMessageFromThread: function(thread_id, box_name, uid, cb){
...
getMessagesFromMailbox: function(box_name, onMessage, limit, offset, cb){
...
getThreads:function(thread_ids, cb){
...
getThread:function(thread_id, cb){
...
saveAttachments:function(box_name, mail_object, cb){
...
ensureProject:function(project_name, cb){
...
getProject:function(project_name, cb){
...
threadMessages:function(message_ids, cb){
	/*
	...
	*/
	...
	var promises = message_ids.map(function(message_id){
		return self.threadMessageAsync(message_id);
	});
...
blockSender: function(sender_address, cb){
...
deleteBoxes:function(box_paths, cb){
...
updateMessage:function(mail_obj, cb){
...
muteThread: function(thread_id, cb){
...
setThreadMuteState:function(thread_id, state, cb){
...
deleteProject:function(project_name, cb){
...
clearProjectFromThread:function(thread_id, cb){
